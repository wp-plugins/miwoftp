...
if (!is_readable(MPATH_MIWOFTP_QX."/_config/conf.php"))
    show_error(MPATH_MIWOFTP_QX."/_config/conf.php not found.. please see installation instructions");

require MPATH_MIWOFTP_QX."/_config/conf.php";
require MPATH_MIWOFTP_QX."/_config/configs.php";
if(isset($GLOBALS["lang"])) $GLOBALS["language"]=$GLOBALS["lang"];
require MPATH_MIWOFTP_QX."/_lang/".$GLOBALS["language"].".php";
require MPATH_MIWOFTP_QX."/_lang/".$GLOBALS["language"]."_mimes.php";
require MPATH_MIWOFTP_QX."/_config/mimes.php";
require MPATH_MIWOFTP_QX."/_include/fun_extra.php";
require_once MPATH_MIWOFTP_QX."/_include/header.php";
require MPATH_MIWOFTP_QX."/_include/footer.php";
ob_start(); // prevent unwanted output
